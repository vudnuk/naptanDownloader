...
var newestList = fileParser.SplitStringIntoList(newerList);

await fileParser.DownloadMultipleFiles(newestList);

// write a function to add a third digit for two digit numbers - newestList should check if it has 3 characters